...
public class LoadMoreFreshListView extends ListView implements OnScrollListener {
	...
	public LoadMoreFreshListView(Context context) {
		this(context,null);
		init(context);
	}

	@SuppressWarnings("deprecation")
	public LoadMoreFreshListView(Context context, AttributeSet attrs) {
		super(context, attrs);
