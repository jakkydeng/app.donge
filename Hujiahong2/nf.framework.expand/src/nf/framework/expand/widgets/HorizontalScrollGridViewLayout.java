 ...
 * date: 2011-05-04
 */
public class HorizontalScrollGridViewLayout extends ViewGroup {
	...
	private OnHorizontalScrollViewItemClickListener onItemClickListener;
	...
	public HorizontalScrollGridViewLayout(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
		// TODO Auto-generated constructor stub
	}

	public HorizontalScrollGridViewLayout(Context context, AttributeSet attrs, int defStyle) {
 ...
 * @param adaperList
 */
	public GridView[] setGridViewView(Context mcontext,int numColumns,int pageCount){
		
		LayoutParams layout_params = new LayoutParams(LayoutParams.FILL_PARENT,	LayoutParams.FILL_PARENT);
		GridView[] gridViews= new GridView[pageCount];
		for (int i = 0; i < pageCount; i++) {
			gridViews[i] = new GridView(mcontext);
			gridViews[i].setLayoutParams(layout_params);
			gridViews[i].setScrollBarStyle(0);
			gridViews[i].setNumColumns(numColumns);
			gridViews[i].setScrollContainer(false);
			gridViews[i].setOnItemClickListener(listener(i));
			this.addView(gridViews[i]);
		}
		return gridViews;
	}
	private OnItemClickListener listener(final int currentPage) {
		OnItemClickListener listener = new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				if(onItemClickListener!=null){
					onItemClickListener.onHorizontalScrollItemClick(parent, view, position, id, currentPage);
				}
			}
	...
	public void setOnHorizontalScrollViewItemClickListener(OnHorizontalScrollViewItemClickListener itemClickListener){
		
		this.onItemClickListener=itemClickListener;
	}
	public interface OnHorizontalScrollViewItemClickListener {
		
		public abstract void onHorizontalScrollItemClick(AdapterView<?> parent, View view,
				int position, long id,int currentPage);
	}
	@Override
