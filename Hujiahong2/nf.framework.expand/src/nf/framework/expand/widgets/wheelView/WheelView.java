...
package nf.framework.expand.widgets.wheelView;
...
public class WheelView extends View
{
    ...
    private void initResourcesIfNecessary()
    {
        ...
        {
            centerDrawable = getContext().getResources().getDrawable(R.drawable.expand_wheel_val);
        }
        ...
        setBackgroundResource(R.drawable.expand_wheel_bg);
    }
