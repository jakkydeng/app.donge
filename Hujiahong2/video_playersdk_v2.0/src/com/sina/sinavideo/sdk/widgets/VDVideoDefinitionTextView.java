 ...
 * @author seven
 */
public class VDVideoDefinitionTextView extends TextView implements VDBaseWidget, OnVMSResolutionListener {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        // 指定相应的音量控制容器类
        TypedArray typedArr = context.obtainStyledAttributes(attrs, R.styleable.VDVideoDefinitionTextView);
        if (typedArr != null) {
        ...
        this.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (container != null) {
                    ...
                    VDVideoViewController controller = VDVideoViewController.getInstance(VDVideoDefinitionTextView.this
                            .getContext());
                    if (controller != null)
    ...
    private void updateText() {
        ...
        if (null == controller)
            return;
        VDResolutionManager resolutionManager = VDResolutionManager.getInstance(controller.getContext());
