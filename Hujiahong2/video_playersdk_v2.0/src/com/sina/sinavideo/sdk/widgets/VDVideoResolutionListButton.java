 ...
 * 
 */
public class VDVideoResolutionListButton extends TextView implements VDBaseWidget, OnResolutionListButtonListener,
        OnResolutionListener {
            ...
            public void onClick(View v) {
                ...
                if (controller != null) {
                    ...
                    if (!videoInfo.mIsLive) {
                        videoInfo.mVideoPosition = controller.getCurrentPosition();
                        videoInfo.mNeedSeekTo = true;
                    }
                    // controller.setResolution(mResolutionTag);
                    if (DLNAController.mIsDLNA) {
                        DLNAController.getInstance(mContext).open(videoInfo.getVideoUrl(mResolutionTag));
                    } else {
                        controller.setVideoPath(videoInfo.getVideoUrl(mResolutionTag));
                    }
                    VDSharedPreferencesUtil.setResolution(mContext, mResolutionTag);
    ...
    private void refreshButtonText() {
        if (mResolutionTag != null) {
            String resolutionText = VDResolutionData.getDefDescTextWithTag(mResolutionTag);
