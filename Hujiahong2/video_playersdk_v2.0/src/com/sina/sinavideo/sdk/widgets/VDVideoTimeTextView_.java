...
public class VDVideoTimeTextView_ extends TextView implements VDBaseWidget,
    ...
    private int mTimeFormat = TIME_FORMAT_PROGRESSONLY;

    public VDVideoTimeTextView_(Context context) {
        super(context);
        setTextColor(Color.WHITE);
    }

    public VDVideoTimeTextView_(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        mTimeFormat = a.getInteger(R.styleable.TimeTextView_TimeFormat, TIME_FORMAT_PROGRESSONLY);
        a.recycle();
    }
