 ...
 * @author seven
 */
public class VDVideoControlPanelContainer_ extends View implements VDBaseWidget {
    ...
    public VDVideoControlPanelContainer_(Context context) {
        super(context);
        init(context, (8 | 4 | 2 | 1));
    }

    public VDVideoControlPanelContainer_(Context context, AttributeSet attrs) {
        super(context, attrs);
