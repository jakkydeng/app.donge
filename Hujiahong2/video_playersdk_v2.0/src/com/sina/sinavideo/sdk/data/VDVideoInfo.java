...
public class VDVideoInfo {
     ...
     * 解析后的直播地址
     */
    // public List<M3u8Resolution> mUrlList;
    // 跳转后的MP4地址
    // TODO 后期优化点，胶水代码，太丑陋了
    ...
    public String getVMSId() {
        if ("0".equals(mVMSId) || TextUtils.isEmpty(mVMSId)) {
            return null;
        }
        return mVMSId;
    }
    ...
    public String getVideoUrl(String tag) {
        ...
        Context context = VDApplication.getInstance().getContext();
        if (context != null) {
            VDResolutionManager resolutionManager = VDResolutionManager.getInstance(context);
            if (resolutionManager != null) {
                if (resolutionManager.getResolutionData().isContainTag(tag)) {
                    return resolutionManager.getResolutionData().getResolutionWithTag(tag).getUrl();
                }
            }
        }
        return mPlayUrl;
    ...
    public String getVMSVideoUrl(String type) {
        ...
        if (context != null) {
            ...
            if (resolutionManager != null) {
                ...
                playUrl = resolutionManager.getResolutionData().getResolutionWithTag(tag).getUrl();
            }
        }
        if (playUrl == null) {
            playUrl = mPlayUrl;
    ...
    public String toString() {
        ...
        return "vid:" + mVideoId + ",vmsId:" + mVMSId + ",title:" + mTitle + ",url:" + mPlayUrl + ",mVideoDuration："
                + mVideoDuration + ",mDescription:" + mDescription;
    }
