...
public class VDResolutionManager {
    ...
    private void initResolutionTag(Context context) {
        if (mResolutionSolutionType == RESOLUTION_SOLUTION_OBTAIN_USER) {
            String savedResolutionTag = VDSharedPreferencesUtil.getCurResolution(context);
     ...
     */
    private VDResolutionData resortResolutionData(VDResolutionData resolutionData) {
        ...
        for (String value : tagList) {
            VDResolution resolution = resolutionData.getResolutionWithTag(value);
            if (resolution != null) {
     ...
     */
    private String nearResolutionTag(VDResolutionData resolutionData, String currTag) {
    ...
    public boolean isParsed() {
        return (mResolutionData != null && mResolutionData.getResolutionSize() > 0) ? true : false;
    }
