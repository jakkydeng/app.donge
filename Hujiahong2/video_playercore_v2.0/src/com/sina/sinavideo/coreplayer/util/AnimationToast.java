...
public class AnimationToast implements Runnable {
    ...
    public AnimationToast(Context context, View view, int bgResId, int textSizeResId) {
        ...
        mPopToast.setWindowLayoutMode(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
     ...
     * 
     */
    public static AnimationToast makeText(Context context, CharSequence text, int duration, View parent, int bgResId,
            int textSizeResId) {
        ...
        AnimationToast result = new AnimationToast(context, tv, bgResId, textSizeResId);
     ...
     */
    public static AnimationToast makeText(Context context, int resId, int duration, View parent, int bgResId,
            int textSizeResId) throws Resources.NotFoundException {
        return makeText(context, context.getResources().getText(resId), duration, parent, bgResId, textSizeResId);
    }
