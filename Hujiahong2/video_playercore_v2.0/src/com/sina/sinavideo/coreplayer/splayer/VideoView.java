...
public class VideoView extends GLSurfaceView implements GLSurfaceView.Renderer, ISinaVideoView {
    ...
    public VideoView(Context context, boolean translucent, int depth, int stencil) {
        super(context);
    ...
    private void openVideo() {
        ...
        if (surfaceViewSupported == false) {
            Toast.makeText(this.getContext(),"播放器仅支持android2.3及以上系统", Toast.LENGTH_SHORT).show();
